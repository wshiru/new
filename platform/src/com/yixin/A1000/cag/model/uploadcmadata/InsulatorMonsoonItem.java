 ...
 * 
 */
public class InsulatorMonsoonItem extends BaseUploadCMADataItem {
	 ...
	 *            数据项值
	 */
	public InsulatorMonsoonItem(String code, String value, String alarm) {
		this.code = code;
		this.value = value;
		this.alarm = alarm;
		if (WINDAGE_YAW_ANGLE.equals(this.code)) { // 风偏角
			...
			this.minInclusive = -90;
			this.maxInclusive = 90;
			this.min = null;
			this.max = null;
			this.pos = 2;
			this.unit = "°";
