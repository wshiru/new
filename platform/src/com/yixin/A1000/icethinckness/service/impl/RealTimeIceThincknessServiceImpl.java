 ...
 * Project platform
 *
 * Class RealTimeIceThincknessServiceImpl.java
 * 
 * Version 1.0.0
 * 
 * Creator 
 ...
 * @author 
 */
public class RealTimeIceThincknessServiceImpl implements RealTimeIceThincknessService {
	 ...
	 * 
	 * @see
	 * com.yixin.ca2000.towertilt.service.RealTimeIceThincknessService#addRealTimeTask
	...
	@Override
	public IceThincknessSampling samplingIceThinckness(Sensor sensor) {
		return this.commService.iceThinckness(sensor.getSensorCode());
	}
}
