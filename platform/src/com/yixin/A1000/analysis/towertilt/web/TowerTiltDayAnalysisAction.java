 ...
 * 
 */
public class TowerTiltDayAnalysisAction extends
	...
	public String list() {
		...
		Page<Map<String, Object>> pages = this.towerTiltAnalysisService
				.getDayTowerTiltSamplings(sensor, beginTime, endTime,
	...
	public String chart() {
		...
		// 生成图形
		this.chart = JFreeChartFactory.createTimeSeriesChart("杆塔倾斜日数据分析曲线图",
	...
	public String exportExcel()
	{
		...
		List<Map<String, Object>> ttSamplings = this.towerTiltAnalysisService.getDayTowerTiltSamplings(sensor, beginTime, endTime);
		...
		String fname = String.format("%s-日数据",newSensor.getSensorCode());
		...
		try {
		    ...
		    boolean ex = this.towerTiltAnalysisService.exportExcel(ContextKeys.DAY_EXPORT, newSensor, beginTime, endTime, ttSamplings, os,null,ContextKeys.NOTHING);
		    if (  ex  ){
