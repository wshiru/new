 ...
 * Project platform
 *
 * Class RealTimeWireTemperatureServiceImpl.java
 * 
 * Version 1.0.0
 * 
 * Creator 
 * CreateAt 2011-7-8 下午04:46:49
 *
 * ModifiedBy 无
 * ModifyAt 无
 * ModifyDescription 无
 ...
 * @author 
 */
public class RealTimeWireTemperatureServiceImpl implements RealTimeWireTemperatureService {
	 ...
	 * 
	 * @see
	 * com.yixin.ca2000.wiretemperature.service.RealTimeWireTemperatureService
	...
	public void addRealTimeTask(User user, Sensor sensor) {
		...
		taskConfig.setSubCmdType(ProtocolCmdSubType.WIRETEMPERATURE);
