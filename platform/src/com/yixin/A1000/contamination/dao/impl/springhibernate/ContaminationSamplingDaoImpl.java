 ...
 * Project platform
 *
 * Classname ContaminationSamplingDaoImpl.java
 * 
 * Version 1.0.0
 * 
 * Creator 
 ...
 */
package com.yixin.A1000.contamination.dao.impl.springhibernate;
...
/**
 * 污秽度监测DAO的Spring+Hibernate实现类
 * 
 * @version v1.0.0
 * @author 
 */
public class ContaminationSamplingDaoImpl extends BaseDaoImpl<ContaminationSampling, String> implements
ContaminationSamplingDao {
	...
	private   List<Map<String, Object>>  formatRetVal(List list){
    	...
    	for (Object o : list) {
			...
			String contaminationSamplingId = String.valueOf(arr[0]);
			map.put("contaminationSamplingId", contaminationSamplingId);
	...
	@SuppressWarnings("rawtypes")
	@Override
	public List<Map<String, Object>> getDayContaminationSamplings(Sensor sensor,
	...
	@Override
	public Page<Map<String, Object>> getDayContaminationSamplings(Sensor sensor,
	...
	@Override
	public List<Map<String, Object>> getMonthContaminationSamplings(Sensor sensor,
			Date beginTime, Date endTime) {
	...
	@Override
	public Page<Map<String, Object>> getMonthContaminationSamplings(Sensor sensor,
			Date beginTime, Date endTime, final long pageNo, final long pageSize) {
	...
	@SuppressWarnings({ "rawtypes", "static-access" })
	@Override
	public List<Map<String, Object>> getYearContaminationSamplings(Sensor sensor,
			Date beginTime, Date endTime) {
		Calendar cal1 = Calendar.getInstance();
		Calendar cal2 = Calendar.getInstance();
	...
	@Override
	public Page<Map<String, Object>> getYearContaminationSamplings(Sensor sensor,
			Date beginTime, Date endTime, final long pageNo, final long pageSize) {
	...
	@SuppressWarnings({ "static-access", "rawtypes", "unchecked" })
	@Override
	public Page<Map<String, Object>> getExtremeValueContaminationSamplings(
	...
	@SuppressWarnings({ "rawtypes", "static-access" })
	@Override
	public List<Map<String, Object>> getExtremeValueContaminationSamplings(
	...
	@Override
	public ContaminationSampling getLastContaminationSampling(Sensor sensor) {
		Map<String, Object> map = new HashMap<String, Object>();
		...
		List<ContaminationSampling> list = this.getAllByProperties(map, dateProperty,1);		 
