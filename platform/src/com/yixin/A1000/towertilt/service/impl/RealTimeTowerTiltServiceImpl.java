 ...
 * @author 
 */
public class RealTimeTowerTiltServiceImpl implements RealTimeTowerTiltService {
	 ...
	 * 
	 * @see
	 * com.yixin.ca2000.towertilt.service.RealTimeTowerTiltService#addRealTimeTask
	...
	@Override
	public TowerTiltSampling samplingTowerTilt(Sensor sensor) {
		return this.commService.towertilt(sensor.getSensorCode());
	}
}
