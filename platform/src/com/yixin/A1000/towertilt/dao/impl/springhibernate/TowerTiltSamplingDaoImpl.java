 ...
 * Project platform
 *
 * Classname TowerTiltSamplingDaoImpl.java
 * 
 * Version 1.0.0
 * 
 * Creator 
 ...
 */
package com.yixin.A1000.towertilt.dao.impl.springhibernate;
...
/**
 * 杆塔倾斜DAO的Spring+Hibernate实现类
 * 
 * @version v1.0.0
 * @author 
 */
public class TowerTiltSamplingDaoImpl extends BaseDaoImpl<TowerTiltSampling, String> implements
		TowerTiltSamplingDao {
	...
	private   List<Map<String, Object>>  formatRetVal(List list){
    	...
    	for (Object o : list) {
			...
			String towerTiltSamplingId = String.valueOf(arr[0]);
			map.put("towerTiltSamplingId", towerTiltSamplingId);
	...
	@Override
	public TowerTiltSampling getLastTowerTiltSampling(Sensor sensor) {
		Map<String, Object> map = new HashMap<String, Object>();
		...
		List<TowerTiltSampling> list = this.getAllByProperties(map, dateProperty,1);		 
