 ...
 */
@Entity
@Table(name="T_TowerTiltParams")
public class TowerTiltParameter {
	...
	private String towerTiltParamsID;
	...
	public String getTowerTiltParamsID() {
		return towerTiltParamsID;
	}

	public void setTowerTiltParamsID(String towerTiltParamsID) {
		this.towerTiltParamsID = towerTiltParamsID;
	}
