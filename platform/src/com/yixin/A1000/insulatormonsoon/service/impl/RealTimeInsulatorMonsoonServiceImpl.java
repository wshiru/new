 ...
 * Project platform
 *
 * Class RealTimeInsulatorMonsoonServiceImpl.java
 * 
 * Version 1.0.0
 * 
 * Creator 
 * CreateAt 2011-7-8 下午04:44:38
 *
 * ModifiedBy 无
 * ModifyAt 无
 * ModifyDescription 无
 ...
 * @author 
 */
public class RealTimeInsulatorMonsoonServiceImpl implements RealTimeInsulatorMonsoonService {
	 ...
	 * 
	 * @see
	 * com.yixin.ca2000.insulatormonsoon.service.RealTimeInsulatorMonsoonService
	...
	public void addRealTimeTask(User user, Sensor sensor) {
		...
		taskConfig.setSubCmdType(ProtocolCmdSubType.INSULATORMONSOON);
