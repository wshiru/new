 ...
 * Project platform
 *
 * Class RealTimeWireSagServiceImpl.java
 * 
 * Version 1.0.0
 * 
 * Creator 
 * CreateAt 2011-7-8 下午04:46:18
 *
 * ModifiedBy 无
 * ModifyAt 无
 * ModifyDescription 无
 ...
 * @author 
 */
public class RealTimeWireSagServiceImpl implements RealTimeWireSagService {
	 ...
	 * 
	 * @see
	 * com.yixin.ca2000.wiresag.service.RealTimeWireSagService#addRealTimeTask
	...
	public void addRealTimeTask(User user, Sensor sensor) {
		...
		taskConfig.setSubCmdType(ProtocolCmdSubType.WIRESEG);
