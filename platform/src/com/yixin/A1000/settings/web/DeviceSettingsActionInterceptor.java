 ...
 * @author 
 */
public class DeviceSettingsActionInterceptor extends AbstractInterceptor {
	private static final Logger logger = Logger.getLogger(DeviceSettingsActionInterceptor.class);
