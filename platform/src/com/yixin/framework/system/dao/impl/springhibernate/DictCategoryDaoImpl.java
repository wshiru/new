 ...
 * Project platform
 *
 * Classname DictCategoryDaoImpl.java
 * 
 * Version 1.0.0
 * 
 * Creator 
 * CreateAt 2011-6-13 上午9:11
 *
 * ModifiedBy 无
 * ModifyAt 无
 * ModifyDescription 无
...
/**
 * 数据字典类型DAO的Spring+Hibernate实现类
 * 
 * @version v1.0.0
 * @author 
 */
public class DictCategoryDaoImpl extends BaseDaoImpl<DictCategory, Integer> implements DictCategoryDao {
