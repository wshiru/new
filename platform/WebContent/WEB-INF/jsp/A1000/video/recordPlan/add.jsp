...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="load();">
		...
		<!-- start 信息区域 -->
		<s:form action="addSave" namespace="/video/recordPlan" method="post"
			theme="simple">
			<table align="center" cellspacing="1" class="tab">
				<tr>
					<td colspan="4" class="td_title">
						填写计划信息 <s:property value="#request.errorMessage"/>
					</td>
				</tr>
				<tr>
					<td class="td_gray150">
					...
					<td colspan="3" class="table_td_left">
						<s:hidden name="id"/>
						<input type="text" name="startTime" value='0:00:00'
							onclick="WdatePicker({dateFmt:'H:mm:ss'})" maxlength="15"
							onfocus="WdatePicker({dateFmt:'H:mm:ss'})" />
					</td>
				</tr>
				<tr>
					<td class="td_gray150">
				...
				<tr>
					...
					<td colspan="3" class="table_td_left">
						<div id="div0">
							打开电源时间：
							<input type="text" name="recordPlan.openTime" value='8' maxLength="3" style="width:30px"/>分钟
						</div>				
						<div id="div1">
						</div>
						<div id="div2">
							录像时间：
							<input type="text" name="recordPlan.recordTime" value='5' maxLength="3" style="width:30px"/>分钟
						</div>
						<div id="div3">
						</div>
						<div id="div4">
							调用预置位：
							<input type="text" name="recordPlan.presetting" value='1' maxLength="3" style="width:30px"/>
						</div>
						<div id="div5">
						</div>
						<div id="div9">
