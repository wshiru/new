...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- start 当前位置 -->
		<div id="tab_position">
				<span class="tab_position_b">终端模型参数</span>
		</div>
		<!-- end 当前位置 -->

		<!-- start 信息区域 -->
		<s:form action="towerTiltModelParam" namespace="/device/settings" method="post" theme="simple">
			...
			<s:iterator value="params" var="arrayIndex" status="stat">
				<tr>
					...
					<td colspan="3" class="table_td_left">
						...
						<s:hidden name="params[%{#stat.index}].name" value="params[%{#stat.index}].desc" />
					</td>
				</tr>
			</s:iterator>
				<tr>
					...
					<td colspan="2" class="table_td2_footer">
						<s:submit value="召测" action="upTowerTiltModelParam" cssClass="btn6" onclick="return showwaiting();" />
						&nbsp;
						<s:submit value="下发" action="downTowerTiltModelParam" cssClass="btn6" onclick="return showwaiting();" />
					</td>
				</tr>
			</table>
		</s:form>
