...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- start 信息区域 -->
		<s:form action="samplingParam" namespace="/device/settings" method="post" theme="simple">
			...
			<table align="center" cellspacing="1" class="tab">
				...
				<tr>
					...
					<td colspan="2" class="table_td2_footer">
						<s:submit value="召测" action="upSamplingParam" cssClass="btn6" onclick="return showwaiting();" />
						&nbsp;
						<s:submit value="下发" action="downSamplingParam" cssClass="btn6" onclick="return showwaiting();" />
					</td>
				</tr>
			</table>
		</s:form>
