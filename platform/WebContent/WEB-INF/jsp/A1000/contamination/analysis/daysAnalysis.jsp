				...
				<table align="center" cellspacing="1" class="tab">
					<tr>
						<td colspan="4" class="table_td_left">
							<s:url action="dayChart" namespace="/contamination/analysis"
								var="chartUrl">
						...
						<td height="30">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td class="first_line_center">
										<div class="div_right">
											<!-- <s:url action="dayChart" namespace="/analysis/contamination" var="chartUrl">
										<s:param name="sensorId" value="sensorId" />
										<s:param name="beginTime">
											<s:date name="beginTime" format="yyyy-MM-dd" />
										</s:param>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td class="third_line_center">
										...
										<yixin:page url="/contamination/analysis/dayList.jspx"
											page="${page}" id="contaminationDayAnalysis_page">
