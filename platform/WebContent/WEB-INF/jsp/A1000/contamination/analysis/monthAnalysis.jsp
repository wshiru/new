				...
				<table align="center" cellspacing="1" class="tab">
					<tr>
						<td colspan="4" class="table_td_left">
							<s:url action="monthChart" namespace="/contamination/analysis"
								var="chartUrl">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td class="third_line_center">
										...
										<yixin:page url="/contamination/analysis/monthList.jspx"
											page="${page}" id="contaminationMonthAnalysis_page">
