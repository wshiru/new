...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- start 信息区域 -->
		<s:form action="addRealTimeTask" namespace="/towerTilt/realTime" method="post" theme="simple">
			...
			<table align="center" cellspacing="1" class="tab">
				...
				<tr>
					...
					<td class="table_td_left">
						<s:property value="%{#request.realTimeDetail.lastData.inclination }" />
					</td>
				</tr>
				...
				<tr>
					...
					<td class="table_td_left">
						<s:property value="%{#request.realTimeDetail.lastData.gradientAlongLines }" />
					</td>
				</tr>
				<tr>
					<td class="td_gray150">
					...
					<td class="table_td_left">
						<s:property value="%{#request.realTimeDetail.lastData.lateralTilt }" />
					</td>
				</tr>
				...
				<tr>
					...
					<td class="table_td_left">
						<s:property value="%{#request.realTimeDetail.lastData.angle_x }" />
					</td>
				</tr>
