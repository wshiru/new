	...
	<body>
		...
		<div id="tab_position">
			...
			<div class="position_c">
				当前位置:首页&nbsp;&gt;&nbsp;参数设置&nbsp;&gt;&nbsp;
				<span class="tab_position_b">监测装置参数</span>
			</div>
		</div>
		<!-- end 当前位置 -->
		...
		<s:form  id="datainfoForm"  action="readSensorParams"  namespace="/setting/sensorParamsSetting" method="post" theme="simple" >
			...
			<table align="center" cellspacing="1" class="tab">
				...
				<tr>
						...
						<td colspan="8" class="table_td2_footer">
							<s:submit id ="p1" value="召测"  action="readSensorParams"  cssClass="btn6" onclick="return confirmSubmit(this)"  />
					        <s:if test="%{#request.deviceParameterdetails.size > 0 }">						
							    &nbsp;&nbsp;&nbsp;
							    <s:submit id="p2" value="下发"  action="writeSensorParams" cssClass="btn6" onclick="return confirmSubmit(this)" />
			                </s:if>
			            </td>
