	...
	<body>
		...
		<div id="tab_position">
			...
			<div class="position_c">
				当前位置:首页&nbsp;&gt;&nbsp;历史数据&nbsp;&gt;&nbsp;
				<span class="tab_position_b">绝缘子串风偏</span>
			</div>
		...
		<!-- start 查询区域 -->
		<s:form id="queryForm" action="list" namespace="/insulatormonsoon/sampling" method="post" theme="simple">
				...
				<td height="30">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="first_line_center">
							      <div class="div_right" >			    
									<s:url action="chart" namespace="/insulatormonsoon/sampling" var="chartUrl">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="third_line_center">
								...
								<yixin:page url="/insulatormonsoon/sampling/list.jspx" page="${pageData}" id="insulatorMonsoonSampling_page">
