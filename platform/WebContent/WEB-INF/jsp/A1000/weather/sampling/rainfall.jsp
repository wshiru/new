...
<html>
	...
	<body>
		<!-- start 当前位置 -->
		<div id="tab_position">
				<span class="tab_position_b">雨量采集数据</span>
		</div>
		<!-- end 当前位置 -->
		
		<!-- start 查询区域 -->
		<s:form id="queryForm" action="listRainfall" namespace="/weather/sampling" method="post" theme="simple">
									...
									<table width="100%" cellspacing="1" class="tab">
										...
										<tr>
											...
											<td colspan="2" class="table_td_left">
												<s:hidden name="showTemperature" value="false"/>
												<s:hidden name="showHumidity" value="false"/>
												<s:hidden name="showWindSpeed" value="false"/>
												<s:hidden name="showWindDirection" value="false"/>
												<s:hidden name="showAirPressure" value="false"/>
												<s:hidden name="showRadiationIntensity" value="false"/>
												<!--
												<s:checkbox name="showHumidity" /><span>湿度</span>
												<s:checkbox name="showWindSpeed" /><span>风速</span>
												<s:checkbox name="showWindDirection" /><span>风向</span>
												<s:checkbox name="showAirPressure" /><span>气压</span>
												<s:checkbox name="showRadiationIntensity" /><span>光辐射度</span>
												-->
												<s:checkbox name="showDailyRainfall" /><span>降雨量</span>
												<s:checkbox name="showPrecipitationIntensity" /><span>降水强度</span>
				...
				<td height="30">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="first_line_center">
							    <div class="div_right" >
									<s:url action="chartRainfall" namespace="/weather/sampling" var="chartUrl">
										...
										<s:param name="showTemperature" value="false" />
										<s:param name="showHumidity" value="false" />
										<s:param name="showWindSpeed" value="false" />
										<s:param name="showWindDirection" value="false" />
										<s:param name="showAirPressure" value="false" />
										<s:param name="showRadiationIntensity" value="false" />
										
										<s:param name="showPrecipitation_Intensity" value="showPrecipitation_Intensity" />
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="third_line_center">
								...
								<yixin:page url="/weather/sampling/listRainfall.jspx" page="${pageData}" id="weatherSampling_page">
									...
									<yixin:hidden name="showAirPressure" value="${requestScope['showAirPressure']}" />
									<yixin:hidden name="showDailyRainfall" value="${requestScope['showDailyRainfall']}" />
									<yixin:hidden name="showRadiationIntensity" value="${requestScope['showRadiationIntensity']}" />
									<yixin:hidden name="showPrecipitation_Intensity" value="${requestScope['showPrecipitation_Intensity']}" />
