...
<html>
	...
	<body>
		...
		<!-- start 查询区域 -->
		<s:form id="queryForm" action="list" namespace="/warning/sensor" method="post" theme="simple">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="third_line_center">
								...
								<yixin:page url="/warning/sensor/list.jspx" page="${pageData}" id="warning_page">
