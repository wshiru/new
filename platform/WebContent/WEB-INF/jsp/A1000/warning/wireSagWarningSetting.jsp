  ...
  <body>
		...
		<div id="tab_position">
			...
			<div class="position_c">
				当前位置:首页&nbsp;&gt;&nbsp;告警管理&nbsp;&gt;&nbsp;
				<span class="tab_position_b">导线弧垂告警阀值设置</span>
			</div>
		</div>
		<!-- end 当前位置 -->
		
		<s:form namespace="/warning/wiresagcondition"  method="post" theme="simple">
			<table align="center" cellspacing="1" class="tab">
				<tr>
					...
					<td class="table_td_left">
						<s:textfield name="sag" />（上限，单位: m）
						<s:fielderror fieldName="sag" cssClass="cRed" />
					</td>
				</tr>
				<tr>
					<td class="td_gray150">
					...
					<td class="table_td_left">
						<s:textfield name="groundDistance" />（上限，单位: m）
						<s:fielderror fieldName="groundDistance" cssClass="cRed" />
					</td>
				</tr>
				<tr>
