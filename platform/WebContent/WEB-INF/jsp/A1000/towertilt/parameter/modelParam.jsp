...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- start 信息区域 -->
		<s:form action="modelParam" namespace="/towertilt/parameter"
			...
			<table align="center" cellspacing="1" class="tab">
				...
				<s:else>
					...
					<tr>
						...
						<td colspan="3" class="table_td_left">
							x0:X方向(顺线方向)倾斜角的初始值。y0:Y方向(横向方向)倾斜角的初始值。单位为(°)。
						</td>
					</tr>
				</s:else>
				<tr>
					...
					<td colspan="2" class="table_td2_footer">
						<s:submit value="召测" action="upModelParam" cssClass="btn6"
							onclick="return showwaiting();" />
						&nbsp;
						<s:submit value="下发" action="downModelParam" cssClass="btn6"
							onclick="return showwaiting();" />
					</td>
				</tr>
			</table>
