...
<html>
	...
	<body>
		...
		<!-- start 查询区域 -->
		<s:form id="queryForm" action="list" namespace="/towertilt/sampling"
				...
				<td height="30">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="first_line_center">
								<div class="div_right">
									<s:url action="chart" namespace="/towertilt/sampling"
										var="chartUrl">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="third_line_center">
								...
								<yixin:page url="/towertilt/sampling/list.jspx"
