...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- start 信息区域 -->
		<s:form action="addSave" namespace="/archive/line" method="post"
			theme="simple">
			<table align="center" cellspacing="1" class="tab">
				...
				<tr>
					...
					<td colspan="3" class="table_td_left">
						<s:textfield name="line.lineCode" maxLength="30" onblur="" />
						（英文或数字）
				...
				<tr>
					...
					<td colspan="3" class="table_td_left">
						<s:textfield name="line.lineName" maxLength="50" onblur="" />
						（中英文或数字）
				...
				<tr>
					...
					<td colspan="3" class="table_td_left">
						<s:select name="line.voltageLevel.dictionaryId"
							list="%{#request.voltageLevels}" headerKey=""
							headerValue="--请选择--" listKey="dictionaryId" listValue="name"></s:select>
						<s:fielderror fieldName="line.voltageLevel.dictionaryId"
							cssClass="cRed" />
					</td>
				</tr>
				<tr>
					...
					<td colspan="3" class="table_td_left">
						<s:textfield name="line.length" maxlength="8"
							onkeyup="this.value = NumberUtil.format(this.value, 10, 2)" />
						（数字，且最多两位小数）
				...
				<tr>
					...
					<td colspan="3" class="table_td_left">
						<s:textarea name="line.lineDesc" cols="60" rows="6" />
						（250个字符）
