...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- start 信息区域 -->
		<s:form action="list" namespace="/archive/towertype" method="post" theme="simple">
			<table align="center" cellspacing="1" class="tab">
				...
				<tr>
					...
					<td colspan="3" class="table_td_left">
						<s:property value="#request.towerType.towerTypeCode" />
					</td>
				</tr>
				<tr>
					<td class="td_gray150">
					...
					<td colspan="3" class="table_td_left">
						<s:property value="#request.towerType.towerTypeName" />
					</td>
				</tr>
				<tr>
					<td class="td_gray150">
					...
					<td colspan="3" class="table_td_left">
						<s:property value="#request.towerType.towerTypeDesc" />
					</td>
				</tr>
				<tr>
					<td class="td_gray150">
