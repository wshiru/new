...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script >
		function clickTitle()
		{
			var titleType = document.getElementsByName("picture.defaultShow");
			var aa = document.getElementsByName("picture.caption");
			if(titleType[0].checked == true)
			{
				aa.value = "现场图片";	
			}			
			else if(titleType[1].checked == true)
			{
				aa.value = "安装图片";
			}
			else if(titleType[2].checked == true)
			{
				aa.value = "其它";
			}
		}
	...
	<body>
		...
		<!-- start 信息区域 -->
		<s:form action="addSave" namespace="/archive/picture" method="post"
			...
			<table align="center" cellspacing="1" class="tab">
				...
				<tr>
					...
					<td colspan="3" class="table_td_left">
						<s:radio name="picture.defaultShow" list="%{#{'1':'现场图片','2':'安装方位','0':'其它'}}" onclick="clickTitle();" />
