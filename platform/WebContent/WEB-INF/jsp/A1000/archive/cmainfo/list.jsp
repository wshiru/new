	...
	<body>
		...
		<div id="tab_position">
			...
			<div class="position_c">
				当前位置:首页&nbsp;&gt;&nbsp;档案管理&nbsp;&gt;&nbsp;监测代理管理&nbsp;&gt;&nbsp;
				<span class="tab_position_b">监测代理列表</span>
			</div>
		...
		<!-- start 查询区域 -->
		<s:form id="queryForm" action="list" namespace="/archive/cmainfo"
									...
									<table width="100%" cellspacing="1" class="tab">
										<tr>
											...
											<td class="table_td_left">
												<s:textfield name="queryModel.cmaCode" maxlength="17" />
											</td>
											<td class="table_td_right td_whith110">
												监测代理名称：
											</td>
											<td class="table_td_left">
												<s:textfield name="queryModel.cmaName" maxlength="50" />
											</td>
										</tr>
										<tr>
											<td class="table_td_right td_whith110">
											...
											<td class="table_td_left">
												<s:textfield name="queryModel.cmaModel" maxlength="50" />
											</td>
											<td class="table_td_right td_whith110">
												状态：
											</td>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<s:form id="infoForm" action="list" namespace="/archive/cmainfo"
				method="post" theme="simple">
				<tr>
					<td height="30">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td class="second_line_center">
									<table cellspacing="1" onmouseover="changeto()"
										...
										<s:iterator value="#request.page.records" var="cmaInfo">
											<tr>
												<td class="second_line">
													<s:property value="#cmaInfo.cmaCode" />
												</td>
												<td class="second_line">
													<s:property value="#cmaInfo.cmaName" />
												</td>
												<td class="second_line">
													<s:property value="#cmaInfo.cmaModel" />
												</td>
												<td class="second_line">
													<s:date name="#cmaInfo.installDate" format="yyyy-MM-dd" />
												</td>
												<td class="second_line">
													<s:if test="%{#cmaInfo.state eq 1}">启用</s:if>
													<s:elseif test="%{#cmaInfo.state eq 0}">
												...
												<td class="second_line">
													<s:url id="detailUrl" action="detail"
														namespace="/archive/cmainfo">
														<s:param name="id">
															<s:property value="#cmaInfo.cmaInfoId" />
														</s:param>
													</s:url>
													...
													<div class="content">
														...
														<img
															...
															width="16" height="16" />
														<s:a href="%{deleteUrl}"
															onclick="return confirm('确定要删除该监测代理信息吗');">删除</s:a>
													</div>
												</td>
											</tr>
										</s:iterator>
				...
				<td height="29">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td class="third_line_left"></td>
							<td class="third_line_center">
								<yixin:page url="/archive/cmainfo/list.jspx" page="${page}"
									id="cmaInfo_page">
									<yixin:hidden name="queryModel.cmaCode"
										value="${requestScope['queryModel.cmaCode']}" />
									<yixin:hidden name="queryModel.cmaName"
										value="${requestScope['queryModel.cmaName']}" />
									<yixin:hidden name="queryModel.cmaModel"
										value="${requestScope['queryModel.cmaModel']}" />
