...
<html>
	...
	<body>
		...
		<!-- start 查询区域 -->
		<s:form id="queryForm" action="yearList" namespace="/analysis/towertilt" method="post" theme="simple">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="third_line_center">
									...
									<s:submit value="导出Excel" cssClass="btn4" action="yearExportExcel" />
									&nbsp;&nbsp;
				...
				<table align="center" cellspacing="1" class="tab">
					<tr>
						<td colspan="4" class="table_td_left">
							     <s:url action="yearChart" namespace="/analysis/towertilt" var="chartUrl">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="third_line_center">
								...
								<yixin:page url="/analysis/towertilt/yearList.jspx" page="${page}" id="towerTiltYearAnalysis_page">
