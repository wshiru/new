...
<html>
	...
	<body>
		...
		<!-- start 查询区域 -->
		<s:form id="queryForm" action="dayList" namespace="/analysis/towertilt" method="post" theme="simple">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="third_line_center">
									...
									&nbsp;&nbsp;
									<s:submit value="导出Excel" cssClass="btn4" action="dayExportExcel" />
									&nbsp;&nbsp;
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="third_line_center">
								...
								<yixin:page url="/analysis/towertilt/dayList.jspx" page="${page}" id="towerTiltDayAnalysis_page">
