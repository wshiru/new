	...
	<body>
		...
		<div id="tab_position">
			...
			<div class="position_c">
				当前位置:首页&nbsp;&gt;&nbsp;历史数据&nbsp;&gt;&nbsp;
				<span class="tab_position_b">导线温度</span>
			</div>
		...
		<!-- start 查询区域 -->
		<s:form id="queryForm" action="list" namespace="/wiretemperature/sampling" method="post" theme="simple">
									...
									<table width="100%" cellspacing="1" class="tab">
										...
										<tr>
											...
											<td colspan="2" class="table_td_left">
												<s:checkbox name="showLineTemperature1" /><span>线温1</span>
												<s:checkbox name="showLineTemperature2" /><span>线温2</span>
				...
				<td height="30">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="first_line_center">
							    <div class="div_right" >
									<s:url action="chart" namespace="/wiretemperature/sampling" var="chartUrl">
										...
										<s:param name="showLineTemperature1" value="showLineTemperature1" />
										<s:param name="showLineTemperature2" value="showLineTemperature2" />
									</s:url>
								...
								<table cellspacing="1" onmouseover="changeto()" onmouseout="changeback()" class="tab">
									...
									<s:iterator value="#request.pageData.records" status="rowstatus">
										<tr>
											...
											<td class="second_line">
												<s:property value="lineTemperature1" />
											</td>
											<td class="second_line">
												<s:property value="lineTemperature2" />
											</td>
										</tr>
									</s:iterator>
								</table>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="third_line_center">
								...
								<yixin:page url="/wiretemperature/sampling/list.jspx" page="${pageData}" id="wireTemperature_page">
									...
									<yixin:hidden name="showLineTemperature1" value="${requestScope['showLineTemperature1']}" />
									<yixin:hidden name="showLineTemperature2" value="${requestScope['showLineTemperature2']}" />
								</yixin:page>
							</td>
							<td class="third_line_right">
								&nbsp;
