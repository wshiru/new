	...
	<body>
		...
		<div id="tab_position">
			...
			<div class="position_c">
				当前位置:首页&nbsp;&gt;&nbsp;实时数据&nbsp;&gt;&nbsp;
				<span class="tab_position_b">导线弧垂抄读</span>
			</div>
		</div>
		<!-- end 当前位置 -->

		<!-- start 信息区域 -->
		<s:form action="addRealTimeTask" namespace="/wireSag/realTime" method="post" theme="simple">
			...
			<table align="center" cellspacing="1" class="tab">
				...
				<tr>
					...
					<td class="table_td_left">
						<s:property value="%{#request.realTimeDetail.lastData.sag }" />
					</td>
				</tr>
				<tr>
					<td class="td_gray150">
					...
					<td class="table_td_left">
						<s:property value="%{#request.realTimeDetail.lastData.groundDistance }" />
					</td>
				</tr>
