	...
	<body>
		...
		<div id="tab_position">
			...
			<div class="position_c">
				当前位置:首页&nbsp;&gt;&nbsp;历史数据&nbsp;&gt;&nbsp;
				<span class="tab_position_b">导线弧垂</span>
			</div>
		...
		<!-- start 查询区域 -->
		<s:form id="queryForm" action="list" namespace="/wiresag/sampling" method="post" theme="simple">
									...
									<table width="100%" cellspacing="1" class="tab">
										...
										<tr>
											...
											<td colspan="2" class="table_td_left">
												<s:checkbox name="showSag" /><span>弧垂</span>
												<s:checkbox name="showGroundDistance" /><span>对地距离</span>
				...
				<td height="30">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="first_line_center">
							    <div class="div_right" >
									<s:url action="chart" namespace="/wiresag/sampling" var="chartUrl">
										...
										<s:param name="showSag" value="showSag" />
										<s:param name="showGroundDistance" value="showGroundDistance" />
									</s:url>
								...
								<table cellspacing="1" onmouseover="changeto()" onmouseout="changeback()" class="tab">
									...
									<s:iterator value="#request.pageData.records" status="rowstatus">
										<tr>
											...
											<td class="second_line">
												<s:property value="sag" />
											</td>
											<td class="second_line">
												<s:property value="groundDistance" />
											</td>
										</tr>
									</s:iterator>
								</table>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="third_line_center">
								...
								<yixin:page url="/wiresag/sampling/list.jspx" page="${pageData}" id="wireSag_page">
									...
									<yixin:hidden name="showSag" value="${requestScope['showSag']}" />
									<yixin:hidden name="showGroundDistance" value="${requestScope['showGroundDistance']}" />
								</yixin:page>
							</td>
							<td class="third_line_right">
								&nbsp;
