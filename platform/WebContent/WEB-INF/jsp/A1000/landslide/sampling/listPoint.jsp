				...
				<td height="30">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="first_line_center">
								<div class="div_right">
									<s:url action="chart" namespace="/landslide/sampling"
										var="chartUrl">
										...
										<s:param name="showSampleNum" value="showSampleNum" />
										<s:param name="angleChart" value="true" />
									</s:url>
								...
								<div class="div_right">
									...
									<s:url action="chart" namespace="/landslide/sampling"
										...
										<s:param name="showSampleNum" value="showSampleNum" />
										<s:param name="angleChart" value="false" />
									</s:url>
									<table cellspacing="0" cellpadding="0">
										<tr>
											<td>
								...
								<table cellspacing="1" onmouseover="changeto()"
									...
									<s:iterator value="#request.pageData.records"
										...
										<tr>
											...
											<s:iterator value="#p.landslideSamplingDetails" status="idx"
												var="d">
												<s:if test="%{#d.pointNo eq  #request.showSampleNum}">
													<td class="second_line">
