...
<html>
	...
	<body>
		...
		<div id="tab_position">
			地质滑坡监测&nbsp;&gt;&nbsp;
				<span class="tab_position_b">月位移值分析</span>
		</div>
		<!-- end 当前位置 -->
				...
				<table align="center" cellspacing="1" class="tab">
					<tr>
						<td colspan="4" class="table_td_left">
							<s:url action="monthChart" namespace="/landslide/displacement"
								var="chartUrl">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td class="third_line_center">
										...
										<yixin:page url="/landslide/displacement/monthList.jspx"
											page="${pageData}" id="landslideQuerySamplingList_page">
